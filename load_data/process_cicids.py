...
def process_tsne_data():
    ...
    testing_df1 = pd.read_csv("./cicids2018/Bot.csv")
    testing_df2 = pd.read_csv("./cicids2018/Brute Force -Web.csv")
    testing_df3 = pd.read_csv("./cicids2018/Brute Force -XSS.csv")
    testing_df4 = pd.read_csv("./cicids2018/DDOS attack-HOIC.csv")
    testing_df5 = pd.read_csv("./cicids2018/DDOS attack-LOIC-UDP.csv")
    testing_df6 = pd.read_csv("./cicids2018/DoS attacks-LOIC-HTTP.csv")
    testing_df7 = pd.read_csv("./cicids2018/DoS attacks-GoldenEye.csv")
    testing_df8 = pd.read_csv("./cicids2018/DoS attacks-Hulk.csv")
    testing_df9 = pd.read_csv("./cicids2018/DoS attacks-SlowHTTPTest.csv")
    testing_df10 = pd.read_csv("./cicids2018/DoS attacks-Slowloris.csv")
    testing_df11 = pd.read_csv("./cicids2018/FTP-BruteForce.csv")
    testing_df12 = pd.read_csv("./cicids2018/Infilteration.csv")
    testing_df13 = pd.read_csv("./cicids2018/SQL Injection.csv")
    testing_df14 = pd.read_csv("./cicids2018/SSH-Bruteforce.csv")
